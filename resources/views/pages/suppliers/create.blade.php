                    ...
                    <div class="row">
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name_of_supplier" value="{{ old('name_of_supplier')}}" placeholder="Name of Supplier">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="contact_number" value="{{ old('contact_number') }}"  placeholder="Contact Number">
