                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header border-bottom">
                                <h4 class="card-title">List Of All Suppliers</h4>
                                <a type="button" href="{{ route('supplier.create') }}" class="btn btn-primary waves-effect waves-float waves-light" style="float: right">Add Supplier</a>
                            </div>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="{{ route('supplier.edit', $info->id) }}">
                                                        ...
                                                        <a class="dropdown-item" href="{{ route('supplier.delete', $info->id) }}">
