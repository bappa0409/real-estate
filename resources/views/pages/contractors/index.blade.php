                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header border-bottom">
                                <h4 class="card-title">List Of All Contractors</h4>
                                <a type="button" href="{{ route('contractor.create') }}" class="btn btn-primary waves-effect waves-float waves-light" style="float: right">Add Contractor</a>
                            </div>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="{{ route('contractor.edit', $info->id) }}">
                                                        ...
                                                        <a class="dropdown-item" href="{{ route('contractor.delete', $info->id) }}">
