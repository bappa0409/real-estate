...
@section('content')
    ...
    <div class="card">
        <div class="card-header border-bottom">
            <h4 class="card-title">Add Billing Form (Supplier)</h4>
            <a type="button" href="" class="btn btn-primary waves-effect waves-float waves-light" style="float: right">Back</a>
        </div>
        @include('include.messages')
        <form class="form" action="{{ route('store.billing.supplier') }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-12">
                        <div class="form-group">
                            ...
                            <select class="select2 form-control form-control-lg" name="supplier_id" id="">
                                <option selected disabled>Select One</option>
                                
                                @foreach ($suppliers as $info)
                                    
                                    <option value="{{ $info->id }}">{{ $info->name_of_supplier }}</option>
                                @endforeach
                            </select>
                            @error('contractor_id')
                    ...
                    <div class="col-md-3 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="supplier_contact_number" value="">
                        </div>
                    </div>
